...
export function DocsPreview() {
  ...
  return (
    <section className="reveal reveal-delay-2 px-gutter py-20 md:py-24">
      <div className="mx-auto max-w-[1160px]">
        <div className="mb-10 flex items-end justify-between gap-8">
          ...
          <Link
            href="/docs"
            className="hidden text-sm font-bold text-primary transition-colors duration-200 ease-out hover:text-primary/80 sm:inline-flex"
          >
            Browse all articles
          </Link>
        </div>

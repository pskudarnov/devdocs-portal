...
export function Footer() {
  ...
  return (
    <footer className="border-t border-outline-variant/20 bg-surface-container-low py-16">
      <div className="mx-auto max-w-[1080px] px-gutter">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="rounded-lg bg-surface-bright p-2 text-on-surface-variant transition-[color,transform] duration-200 ease-out hover:scale-[1.03] hover:text-primary active:scale-[0.97] motion-reduce:transition-none motion-reduce:hover:scale-100 motion-reduce:active:scale-100"
